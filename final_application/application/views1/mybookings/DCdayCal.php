   ...
   <div class="col-md-12">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h2 class="panel-title">Special Days Calendar</h2>
		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li><a href="<?php echo base_url(); ?>DCavailabiltycalendar" >Availability Calendar</a></li>
					<li class="active" ><a href="<?php echo base_url(); ?>DCavailabiltycalendar/dayCal" >Special Dates</a></li>
				</ul>
...
//                loadResources();
                ...
                function loadEvents() {
                    dp.events.load("<?php echo base_url('DCavailabiltycalendar/eventslist'); ?>");  // POST request with "start" and "end" JSON parameters
                }
