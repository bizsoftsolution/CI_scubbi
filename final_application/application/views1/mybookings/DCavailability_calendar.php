		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li class="active" ><a href="<?php echo base_url(); ?>DCavailabiltycalendar" >Calendar Assignment</a></li>
...
?>
					<div class="row">
						<div class="col-md-12">
							...
							<div style="display:inline-block; left-margin:180px;" >
	<?php
				$result1 = $this->db->query("SELECT * FROM tbl_daycolor"); // '.$params->start.'");
	 
				$colors = $result1->result_array();
				//echo $disp = "<div>Cell Color Legend</div>";
				foreach ($colors as $color) {
				?>
					
					<p style="background-color:<?php echo $color['dftcolor']; ?>; float:left;margin:3px 3px;padding:5px;"><?php echo $color["id"]; ?> - <?php echo $color["desc"]; ?></p>
    ...
    border: 1px solid #dad3d3;">
		...
		<script type="text/javascript">
               ...
               dp.onEventClicked = function(args) {
                ...
                function loadEvents() {
                    dp.events.load("<?php echo base_url('DCavailabiltycalendar/busy'); ?>");  // POST request with "start" and "end" JSON parameters
                }
