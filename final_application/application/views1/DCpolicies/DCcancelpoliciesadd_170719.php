					...
					<div class="form-group">
					 ...
					 <div class="form-group">
						...
						<div class="col-md-12" style="background:whitesmoke;">
							<div class="row">
								<div class="col-md-3">
									<input type="text" name="cancellation_amount[]" class="form-control" data-popup="tooltip" title="Cancellation Amount(It is required field)" data-placement="bottom">
								</div>
								<div class="col-md-1">
							...
							<div class="row">
								<div class="col-md-3">
									<input type="text" name="cancellation_days[]" class="form-control" data-popup="tooltip" title="Cancellation Days(It is required field)" data-placement="bottom">
								</div>
								<div class="col-md-1">
									<label class="control-label col-md-12">Days</label>
								</div>
								<div class="col-md-5">
									<select name="cancellation_period[]" class="form-control" data-popup="tooltip" title="Cancellation Period(It is required field)" data-placement="bottom">
