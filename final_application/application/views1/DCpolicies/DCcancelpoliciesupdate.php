         ...
         <div class="container-fluid">
            ...
            <div class="col-md-10">
			   ...
			   <?php foreach($getEditdata as $row){?>
				...
				<hr>
               	<form name="add" method="POST" action="<?php echo  base_url();?>DCpolicies/editCancellation/<?php echo $row->id; ?>" class="form-horizontal" enctype="multipart/form-data">
                  <div class="form-body">
					<div class="form-group">
                        <label class="control-label col-md-3"><b>Cancellation Policy Name</b> <strong style="color:red;">*</strong></label>
                        <div class="col-md-9">
                           <input name="name" class="form-control" type="text" data-popup="tooltip" title="Cancellation Policy Name(It is required field)" data-placement="bottom" value="<?php echo $row->cancellation_name; ?>">
					 ...
					 <div class="form-group">
						...
						<div class="col-md-9">
							...
							<input type="radio" class="styled" name="cancellation_policy_type" id="chkapplypromoyes" value="Cancellation with Penalty" <?php if($row->cancellation_policy_type == 'Cancellation with Penalty'){ echo  "checked";} ?> >Cancellation with Penalty</label>
							<label class="checkbox-inline"><input type="radio" class="styled" name="cancellation_policy_type" id="chkapplypromono" value="Cancellation is Free" <?php if($row->cancellation_policy_type == 'Cancellation is Free'){ echo  "checked";} ?>>Cancellation is Free</label>
						</div>
					 </div>
					 <?php
					 if($row->cancellation_policy_type == 'Cancellation with Penalty')
					 {
					 ?>
					 <div id="dvapplypromo" >
					 <div class="form-group">
						...
						<div class="field_wrapper">
							 <?php 
								 ...
								 $chk007=$row->cancellation_charged;
						...
						<div class="col-md-12" style="background:whitesmoke;">
							<div class="row">
								<div class="col-md-3">
									<input type="number" name="cancellation_amount[]" class="form-control" data-popup="tooltip" title="Cancellation Amount(It is required field)" data-placement="bottom" value="<?php echo $arr003[$i]; ?>">
								</div>
								...
								<div class="col-md-5">
									<select name="cancellation_total_product[]" class="form-control" data-popup="tooltip" title="Cancellation Product Type(It is required field)" data-placement="bottom">
										...
										<option value="Amount" <?php echo ($arr004[$i]=="Amount" ? "selected" : "") ?>>Amount</option>
										<option value="% of Deposit Paid" <?php echo ($arr004[$i]=="% of Deposit Paid" ? "selected" : "") ?>>% of Deposit Paid</option>
										<option value="Cancellation Fee" <?php echo ($arr004[$i]=="Cancellation Fee" ? "selected" : "") ?> >Cancellation Fee</option>
									</select>
								</div>
								<div class="col-md-3">
									 <select name="cancellation_charged[]" class="form-control" data-popup="tooltip" title="Cancellation Product Type(It is required field)" data-placement="bottom">
										<option value="Will be penalized" <?php echo ($arr007[$i]=="Will be penalized" ? "selected" : "") ?>>Will be penalized</option>
										<option value="will be refunded" <?php echo ($arr007[$i]=="Will be refunded" ? "selected" : "") ?>>will be refunded</option>
									</select>
								</div>
							</div>
							<div class="row">&nbsp;</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input type="text" placeholder ="No of days" name="cancellation_days[]" class="form-control" data-popup="tooltip" title="Cancellation Days(It is required field)" data-placement="bottom" value="<?php echo $arr005[$i]; ?>">
								</div>
								<div class="col-md-5">
								...
								<div class="row">
							<div class="col-md-12">
									<input type="text" value="" readonly="" name="cancellation_period[]" class="form-control" data-popup="tooltip" title="Cancellation Days(It is required field)" data-placement="bottom">
							...
							<a href="javascript:void(0);" class="remove_button btn btn-default" title="Remove field"><img src="<?php echo base_url(); ?>/upload/images/minus.png" style="width:25px; height:25px;"/>Click Here Remove</a>
					...
					<?php }
					 if($row->cancellation_policy_type == 'Cancellation is Free')
					 {
					 ?>
					
					 <div id="dvapplypromo1"  >
					 <div class="form-group">
						<div class="field_wrapper1">
						
						 <?php 
								
								 $chk0051=$row->cancellation_days;
								 $arr0051=explode(",",$chk0051);
								
								 $j=0;
								foreach($arr0051 as $val0051)
								{ 
									if(!empty($arr0051[$j]))
									{
								?>
						...
						<div class="col-md-12" style="background:whitesmoke;">
							<div class="row">
								<div class="col-md-12 hide">
									<input type="hidden" name="cancellation_amount[]" class="form-control" data-popup="tooltip" title="Cancellation Amount(It is required field)" data-placement="bottom" value="">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input type="text" placeholder ="No of days" name="cancellation_days[]" class="form-control" data-popup="tooltip" title="Cancellation Days(It is required field)" data-placement="bottom" value="<?php echo $arr0051[$j] ;?>">
								</div>
								<div class="col-md-4">
									<label class="control-label col-md-12">Days Before Arrival Date</label>
								</div>
						...
						<a href="javascript:void(0);" class="remove_button1 btn btn-default" title="Remove field"><img src="<?php echo base_url(); ?>/upload/images/minus.png" style="width:25px; height:25px;"/>Click Here Remove</a>
						</div>
						<?php
