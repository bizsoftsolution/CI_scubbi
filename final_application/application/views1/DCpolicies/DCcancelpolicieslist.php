      ...
      <!-- Traffic sources -->
       ...
       <table class="table datatable-button-print-columns">
            ...
            ?>
              ...
              </a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>DCpolicies/deleteCancellation/<?php echo $row->id;?>"  title="Delete" class="btn bg-danger remove" onclick="return confirm('Are You Sure to delete');"><i class="glyphicon glyphicon-remove "></i></a>
              </td>
              </tr>
              <?php $i++;}?>
            </tbody>
