      ...
      <div class="panel panel-flat">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-10">
               ...
               <form name="add" method="POST" action="<?php echo  base_url();?>DCpolicies/updateProduct1" class="form-horizontal form-validate-jquery" 
...
<script type="text/javascript">// <![CDATA[
				 ...
				 $('#islands').append(opt); //here we will append these new select options to a dropdown with the id 'cities'
                  ...
                  <div style="text-align:center">
                     <input type="submit" name="update_bookig_product1" value="Add" class="btn btn-success">
