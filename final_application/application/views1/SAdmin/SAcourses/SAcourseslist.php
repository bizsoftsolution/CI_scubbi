		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					...
					<li class="active"><a href="<?php echo base_url(); ?>SAcourses/SAcourseslist" >Add Standard Product</a></li>
					<li ><a href="<?php echo base_url(); ?>SAcourses/addNew" >Add Customized Product</a></li>
				</ul>
      ...
      <!-- Traffic sources -->
        ...
        <table class="table datatable-button-print-columns">
            ...
            ?>
              ...
              <a href="<?php echo base_url(); ?>SAcourses/enable/<?php echo $row->id;?>"  title="Enable" class="btn bg-success remove" onclick="return confirm('Are You Sure want to Enable');"><!--i class="glyphicon glyphicon-remove "></i-->Enable</a>&nbsp;&nbsp;
             <a href="<?php echo base_url(); ?>SAcourses/disable/<?php echo $row->id;?>"  title="Disable" class="btn bg-danger remove" onclick="return confirm('Are You Sure want to Disable');"><!--i class="glyphicon glyphicon-remove "></i-->Disable</a>
              </td>
              </tr>
              <?php $i++;}?>
            </tbody>
