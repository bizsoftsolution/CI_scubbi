							...
							<tr id="1">
								...
								<div class="table-responsive" style="background:lightblue;margin:2px 0 0 0;">
									<table class="table">
										...
										<tr>
										<td>single room</td>
										<td><input type="text" style="width:50px;" class="dcr1" name="text5[]" id="dcr1" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr2" name="text5[]" id="dcr2" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr3" name="text5[]" id="dcr3" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr4" name="text5[]" id="dcr4" readonly>myr/pax</td>
										</tr><tr>
										<td>twin room</td>
										<td><input type="text" style="width:50px;" class="dcr5" name="text6[]" id="dcr5" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr6" name="text6[]" id="dcr6" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr7" name="text6[]" id="dcr7" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr8" name="text6[]" id="dcr8" readonly>myr/pax</td>
										</tr><tr>
										<td>3 person room</td>
										<td><input type="text" style="width:50px;" class="dcr9" name="text7[]" id="dcr9" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr10" name="text7[]" id="dcr10" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr11" name="text7[]" id="dcr11" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr12" name="text7[]" id="dcr12" readonly>myr/pax</td>
										</tr><tr>
										<td>quad room</td>
										<td><input type="text" style="width:50px;" class="dcr13" name="text8[]" id="dcr13" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr14" name="text8[]" id="dcr14" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr15" name="text8[]" id="dcr15" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr16" name="text8[]" id="dcr16" readonly>myr/pax</td></tr>
										<?php
											$data24 = $this->db->get_where('tbl_dcprofile', array('user_id'=>$this->session->userdata('user_id')))->result();
											foreach($data24 as $row_data24)
											{
										...
										<td><input type="text" style="width:50px;" class="dcr17" name="text18[]" id="dcr17" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr18" name="text18[]" id="dcr18" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr19" name="text18[]" id="dcr19" readonly>myr/pax</td>
										<td><input type="text" style="width:50px;" class="dcr20" name="text18[]" id="dcr20" readonly>myr/pax</td></tr>
										<?php 
												}
											}
										?>
