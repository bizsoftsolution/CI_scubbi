			   ...
			   <form name="add"   method="POST" action="<?php echo  base_url();?>SAdivepoint/editData/<?php echo $row->id;?>" class="form-horizontal" enctype="multipart/form-data">
                  <div class="form-body">
					 <div class="form-group">
						...
						<?php if ($row->image!="") { 
						//echo $row->image;
						$img = explode(',' , trim($row->image, ','));
						foreach($img as $rowimg)
						{
							?>
							<div class="field_wrapper99">
								<div class="col-md-3" style="    padding: 0px 2px;">
							<img src="<?php echo base_url(); ?>upload/divepoint/<?php echo $rowimg; ?>" class="img-responsive" style="width:180px; height:100px;    padding: 3px;">
...
*/
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="name" class="form-control" type="text" value="<?php echo $row->name; ?>" required>
