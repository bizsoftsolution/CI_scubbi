		...
		<legend class="text-semibold">General Info</legend>
                                                        ...
                                                        <fieldset title="2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <label class="checkbox-inline" style="padding-left: 0px;">
                                                                        <input type="radio" class="styled" name="productunits" value="Dive" onClick="showTextBox1000()" />Dive</label>
                                                                    <label class="checkbox-inline">
...
//-->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input name="maxdiveday" class="form-control max_dive_per_day" type="number" data-popup="tooltip" title="Max Dive(It is required field)" data-placement="bottom" readonly>
                                                                    <span class="help-block"></span>
                                                                </div>
                                                            </div>
		<script>
		...
		<div class="form-group disable_promodiscount">
			...
			<div class="col-md-9">
				...
				<label class="checkbox-inline">
					<input type="radio" class="styled apbd_removw1" name="apbulkdiscount" id="apbulkdiscountNo" onClick="showTextBox95()" value="No">NO</label>
			</div>
		</div>
