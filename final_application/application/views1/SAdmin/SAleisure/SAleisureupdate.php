         ...
         <div class="container-fluid">
							...
							if(text_box.hasAttribute('readonly')){    
								...
								text_box.setAttribute('readonly', 'readonly');    
                                        ...
                                        <!--****************************************************************************************************************************************************************************************************************************************************************************************************													START APPLY DISCOUNT FOR BULK PURCHASE *****************************************************************************************************************************************************************************************************************************************************************************************************-->
														...
														<div>
															<input type="text" name="startrange[]" style="width:50px;" class="startrange startrange1" value="<?php echo $arr_strrange1[$i];?>"> TO
															<input type="text" name="endrange[]" style="width:50px;" class="endrange endrange1" value="<?php echo $arr_endrange1[$i]; ?>"> DISCOUNT:
				...
				<?php 
					...
					?>	
						...
						{
					?>
				<div class="testcase1" style="background:#eeeeee;padding:1%;">
						<?php 
