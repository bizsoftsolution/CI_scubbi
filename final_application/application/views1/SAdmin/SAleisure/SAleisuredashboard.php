	...
	<div class="panel panel-flat">
        ...
        ?>
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li class="active"><a href="<?php echo base_url(); ?>SAleisure/SAleisuredashboard" >Dashboard</a></li>
					<li ><a href="<?php echo base_url(); ?>SAleisure/addNew" >Add Standard Product</a></li>
      ...
      <!-- Traffic sources -->
        ...
        <table class="table datatable-button-print-columns">
            ...
            <?php
            $i=1;
              foreach($SAleisuredashboard as $row) {
            ?>
              <tr>
              ...
              <a href="<?php echo base_url(); ?>SAleisure/edit/<?php echo $row->id;?>" title="Edit" class="btn bg-success"><i class="glyphicon glyphicon-pencil "></i>
              </a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>SAleisure/delete/<?php echo $row->id;?>"  title="Delete" class="btn bg-danger remove" onclick="return confirm('Are You Sure to delete');"><i class="glyphicon glyphicon-remove "></i></a>
              </td>
              </tr>
              <?php $i++;}?>
            </tbody>
