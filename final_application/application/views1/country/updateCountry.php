               ...
               <form name="add"   method="POST" action="<?php echo  base_url();?>country/editCountry/<?php echo $row->country_id;?>" class="form-horizontal">
                  <div class="form-body">
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="name" placeholder="Country Name" class="form-control" type="text" value="<?php echo $row->country_name;?>">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
						    <textarea name="description" class="form-control" id="editor-full1"  data-placement="bottom" required=""><?php echo $row->country_desc; ?></textarea>
							<span class="help-block"></span>
                        </div>
                     </div>
                  </div>
