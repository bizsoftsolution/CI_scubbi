      ...
      <div class="panel panel-flat">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-8">
               ...
               <?php } ?>
               <form name="add"   method="POST" action="<?php echo  base_url();?>Sociallink/addNew" class="form-horizontal form-validate-jquery">
                  <div class="form-body">
                     <div class="form-group">
                        <label class="control-label col-md-3">Social Link Name</label>
                        <div class="col-md-9">
                           <input name="name" placeholder="Social Link Name" class="form-control" type="text" required="">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="link" placeholder="Social Link" class="form-control" type="text" required="">
                           <span class="help-block"></span>
                        </div>
                     </div>
                  </div>
