   ...
   <div class="col-md-12">
	...
	<fieldset title="1">
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-md-3"><b>Common options</b> <strong style="color:red;">*</strong></label>
				<div class="col-md-9">
					<div class="row">
                        ...
                        <div class="col-md-9">
							<div class="row">
								<div class="col-md-12">
									<label class="control-label col-md-3">Normal Rate</label>
									 <div class="col-md-6">
										<input name="normal_product_price" class="form-control" type="text"  data-popup="tooltip" title="Normal Rate(It is required field)" data-placement="bottom">
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<input name="weekend_product_price" class="form-control" type="text"  data-popup="tooltip" title="Weekend Rate(It is required field)" data-placement="bottom">
									</div>
									<div class="col-md-3"><span class="help-block">MYR / PAX</span></div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<input name="peak_product_price" class="form-control" type="text"  data-popup="tooltip" title="Peak Season Rate(It is required field)" data-placement="bottom">
									</div>
									<div class="col-md-3"><span class="help-block">MYR / PAX</span></div>
								</div>
							</div>
