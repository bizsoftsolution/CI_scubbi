		...
		*/
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-2"> 
									<input name="single_room[]" class="form-control sr" type="text" value="<?php echo $arr_p_i_a_s[0]; ?>" id="pp01">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="single_room[]" class="form-control sr" type="text" value="<?php echo $arr_p_i_a_s[1]; ?>" id="pp02">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="single_room[]" class="form-control sr" type="text" value="<?php echo $arr_p_i_a_s[2]; ?>" id="pp03">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="single_room[]" class="form-control sr" type="text" value="<?php echo $arr_p_i_a_s[3]; ?>" id="pp04">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-2"> 
									<input name="twin_room[]" class="form-control tr" type="text" value="<?php echo $arr_p_i_a_t[0]; ?>" id="pp5">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="twin_room[]" class="form-control tr" type="text" value="<?php echo $arr_p_i_a_t[1]; ?>" id="pp6">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="twin_room[]" class="form-control tr" type="text" value="<?php echo $arr_p_i_a_t[2]; ?>" id="pp7">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="twin_room[]" class="form-control tr" type="text" value="<?php echo $arr_p_i_a_t[3]; ?>" id="pp8">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-2"> 
									<input name="three_person_room[]" class="form-control tpr" type="text" 
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-2"> 
									<input name="quad_room[]" class="form-control qr" type="text" value="<?php echo $arr_p_i_a_q[0]; ?>" id="pp13">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="quad_room[]" class="form-control qr" type="text" value="<?php echo $arr_p_i_a_q[1]; ?>" id="pp14">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="quad_room[]" class="form-control qr" type="text" value="<?php echo $arr_p_i_a_q[2]; ?>" id="pp15">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
									<div class="col-md-2"> 
									<input name="quad_room[]" class="form-control qr" type="text" value="<?php echo $arr_p_i_a_q[3]; ?>" id="pp16">
									</div>
									<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
										...
										<div class="col-md-9">
											<div class="table-responsive" style="background:lightblue;">
												<table class="table">
													...
													<tr>
													<td>single room</td>
													<td><input type="text" style="width:50px;" class="dcr11" name="text13[]" readonly><?php echo $dccur; ?>/PAX</td>
