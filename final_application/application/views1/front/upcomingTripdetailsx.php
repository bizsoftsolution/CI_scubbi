							...
							<div class="row">
								...
								<div class="col-md-6 text-right">
									<h5 style="padding:0px 10px">
										...
										<button href="" title="Delete" class="btn btn-success remove delete_btn">Cancel The Trip</button>
							...
							<div class="row">
								...
								<div class="col-md-9">
									...
									<div class="row">
										...
										<div class="col-md-6"><p align="left" style="color:#000;"><b>Status : <label style="color:red"><?php echo ($data_bk_NO->status == "PAYING" ? "CONFIRMED" : $data_bk_NO->status); ?></label></b><p></div>
									</div>
									<?php 
									}
									else
									...
									<table class="table" border="1" style="border: 1px solid #eee;">
										...
										{	
											...
											foreach($res123 as $row341)
											{
												...
												$this->db->where('id',$row341->booking_policy);
												$querya = $this->db->get();
												$resa = $querya->result();
												?>
													<ul>
												...
												{
													echo "<li><p>".$rowa->booking_name."</p></li>";
												}
												?>
													</ul>
												<?php
