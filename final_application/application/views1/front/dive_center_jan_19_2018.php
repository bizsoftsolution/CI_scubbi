										...
										<table class="table" style="text-align: justify;font-family: initial;font-size: 15px;LINE-HEIGHT: 1.8;word-spacing: 1px;">
											...
											<tr>
												...
												<div class="row">&nbsp;</div>
													...
													<div class="row">
													<?php 
														$data11 = $this->db->get("tbl_contacts_divemaster")->result();
															...
															<button type="button" name="add_cart" class="expandLeisureDive"  data-productid="<?php echo $cval21->id; ?>" data-table="tbl_dcleisure" data-diveid="<?php echo $lesuiredive; ?>" data-availstatus="<?php echo $availstatus; ?>" style="background-color: #fff;border: none;width: 100%;"/>
																	...
																	if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																	{
																		if($cval21->apply_promo_bulk_discount == "Yes")
																		{
																			...
																			if($amount > 0)
																			{
																				...
																				$currentCurrency = ucwords(strtoupper($divecenterval->dccurrency));
																				...
																				?>
																				<div class="col-md-4">
																					<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php //echo ucwords(strtoupper($divecenterval->dccurrency));?>MYR&nbsp;&nbsp;<?php echo $amount12; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																				</div>
																				<?php
																			}
																			else
																			{ 
																				...
																				?>
																				<div class="col-md-4">
																					<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php //echo ucwords(strtoupper($divecenterval->dccurrency));?>MYR&nbsp;&nbsp;<?php echo $amount123; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																				</div>
																		<?php
																			}
																		}
																	...
																	else
																	{
																		...
																		if($cval21->discount_bulk_purchase == 'Yes')
																		{
																			...
																			else
																			{
																				...
																				?>
																				<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php //echo ucwords(strtoupper($divecenterval->dccurrency));?>MYR&nbsp;&nbsp;<?php echo $amount21; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
																				<?php
																...
																else
																{
																	...
																	<div class="col-md-4">
																		...
																		//echo ucwords(strtoupper($divecenterval->dccurrency));?>MYR&nbsp;&nbsp;<?php
																		echo $amount21; 
...
*/
    ...
    $CI =& get_instance();
  $result1 =   $CI->courseRoomrates($data121 , $daytype , '1' ,$no_of_persons);
									...
									$accom = $result1['accom'];
										...
										//	 echo $disprice; 
																		...
																		?>
																		<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo number_format($disprice,'2'); ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
...
//var_dump($data121);
									...
									//	 echo $disprice; 
																		...
																		?>
																		<div class="col-md-3">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo number_format($disprice12,'2'); ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
