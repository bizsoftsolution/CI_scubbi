 ...
 <script type="text/javascript" src="<?php echo base_url('assets/frontend/js/jquery-3.1.1.js1'); ?>"></script>
        ...
        <div class="modal-content">
            ...
            <div class="login-box-inner" style="height:600px; overflow-y:scroll;">
				...
				<div id="signupFrom">
					...
					<script src="<?php echo base_url(); ?>assets/calendar/dobPicker.min.js1"></script>
