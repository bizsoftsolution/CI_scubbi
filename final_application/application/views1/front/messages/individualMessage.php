							...
							?>
								...
								<div class="row">
									<div class="col-md-10" style="padding: 10px;background-color: #9ae487;border-radius: 11px;margin:15px 0px;">
										...
										<span class="listing-desc-date" style="float: right;color: #fff;font-weight: bold;"><i class="fa fa-calendar"></i> <?php echo date("d-m-Y h:m:s", strtotime($converList->time));?></span>
									 </div>		
									<div class="col-md-2">
									<?php 
