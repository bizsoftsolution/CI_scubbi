															...
															<button type="button" name="add_cart" class="expandLeisureDive"  data-productid="<?php echo $cval21->id; ?>" data-table="tbl_dcleisure" data-diveid="<?php echo $lesuiredive; ?>" data-availstatus="<?php echo $availstatus; ?>" style="background-color: #fff;border: none;width: 100%;"/>
																...
																}													if($cval21->apply_promo == 'Yes')
																{
																	...
																	if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																	{
																		?>
																	<div class="col-md-4">
																		<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $cval21->ap_discount_amount; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																	</div>
																		<?php
															...
															<button type="button" name="add_cart" class="expandLeisureDive"  data-productid="<?php echo $cval21->id; ?>" data-table="tbl_dccourses" data-diveid="<?php echo $lesuiredive; ?>" data-availstatus="<?php echo $availstatus; ?>" style="background-color: #fff;border: none;width: 100%;"/>
																...
																if($cval21->product_normal_rate == '0.00')
																{
																	if($cval21->apply_promo == 'Yes')
																	{
																		...
																		if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																		{
																			$amt1 = explode(',',$cval21->apply_promo_single_room);
																			$t=0;
																			foreach($amt1 as $newamt1)
																			{
																				if($t==0)
																				{
																			?>
																			...
																			<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $newamt1; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
																			<?php
																				}
																			$t++;
																		...
																		{
																			$amt = explode(',',$cval21->product_inclusive_accomodation_single);
																			$t=0;
																			foreach($amt as $newamt)
																			{
																				if($t==0)
																				{
																				$logprodinfo .= "  - Product Price with accomodation " . $newamt[$t] . " \n";
																		?>
																		<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $newamt; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
																		<?php
																				}
																		$t++;
																...
																else
																{
																	...
																	if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																	{
																		?>
																		<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $cval21->apply_promo_nr; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
																<?php
																	}
																	else
																	{
																		...
																		$logprodinfo .= "  - Product Price without accomodation " . $cval21->product_normal_rate . " \n";
																		?>
																		<div class="col-md-4">
																...
																if($cval21->product_normal_rate == '0.00')
																{
																	...
																	if($cval21->apply_promo == 'Yes')
																	{
																		...
																		if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																		{
																			...
																			?>
																			<div class="col-md-3">
																				<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $newamt1; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																			</div>
																			<?php
																				}
																			$t++;
																		...
																		else
																		{
																			...
																			?>
																			<div class="col-md-3">
																				<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $newamt; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																			</div>
																			<?php
																				}
																			$t++;
																	...
																	{
																		$aa = explode(',',$cval21->single_room);
																		$t1=0;
																		//var_dump($aa[0]);
																		//echo $cval21->single_room;
																		foreach($aa as $newamt3)
																		{
																		...
																		?>
																		<div class="col-md-3">
																			<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $newamt3; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
																		<?php
																			}
																			$t1++;
																...
																else
																{
																	if($cval21->apply_promo == 'Yes')
																	{
																		...
																		if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																		{
																			?>
																			<div class="col-md-3">
																				<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $cval21->apply_promo_nr; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																			</div>
																	<?php
																	//echo "4";
																		}
																		else
																		{
																			?>
																			<div class="col-md-3">
																				<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php echo ucwords(strtoupper($divecenterval->dccurrency));?>&nbsp;&nbsp;<?php echo $cval21->product_normal_rate; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																			</div>
																			<?php
																		//echo "5";
																		}
