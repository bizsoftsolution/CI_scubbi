					...
					<table class="table">
						<tr>
							<td style="width:100px;">
								...
								<img src="<?php echo base_url(); ?>assets/images/logo-new-chrcle-small.jpg" alt="" class="img-responsive" style="width:80px;">
							</td>
							<td>
								<div  style=" font: 400 20px/0.8 'Cookie', Helvetica, sans-serif; padding:30px 15px;margin-top: 13px;">Connecting Drivers Globally</div>
							</td>
								...
								<div class="table-responsive">
									<table class="table" style="margin-bottom:0px;">
										<tr>
											...
											<td style="background:#66ffff;font-weight:bold">STATUS: &nbsp;<?php echo $data_bk_NO->status?></td>
										</tr>
									</table>
								</div>
							...
							<div class="row">
								...
								<div class="table-responsive">
									<table class="table"  style="border: 1px solid #eee;">
										...
										<tr>
											<td align="center"><img src="<?php echo base_url(); ?>upload/DCprofile/<?php echo $data1_bk_profile->dcimage; ?>" class="img-circle" style="width:150px;"/></td>
											<td colspan="4" style="padding:10px;">
												<table class="table" border="1">
												<tr>
												<td colspan="2" style="padding:7px;"><b>Your Booking Number is <label style="color:red"> <?php echo $data_bk_NO->booking_no; ?></label></b></td>
												<td colspan="2" style="padding:7px;"><b>Order Confirmed on &nbsp;<label style="color:red"><?php echo date("d/m/Y", strtotime($data_bk_NO->created)); ?></label></b></td>
												</tr>
												<tr><td colspan="2" style="padding:7px;"><b>Dive Center Name</b></td><td colspan="2" style="padding:7px;"><?php echo $data1_bk_profile->dcname; ?></td></tr>
												<tr><td style="padding:7px;"><b>Arrival Date</b></td>
												...
												?></td></tr>
												<tr><td style="padding:7px;"><b>Contact Person</b></td><td>&nbsp;</td><td style="padding:7px;"><b>Contact No</b></td><td style="padding:7px;"><?php echo $data1_bk_profile->dctelephone_no; ?><br> </td></tr>
												<tr><td colspan="2" style="padding:7px;"><b>Address</b></td>
												<td colspan="2" style="padding:7px;"><?php echo $data1_bk_profile->dcaddress; ?><br>
												<?php 
								...
								<div class="">
									<div class="table-responsive">
										<table class="table table-striped" border="1" style="border: 1px solid #eee;">
											<tr>
												<td style="padding:7px;"><b>Product Name</b></td>
												<td colspan="3" style="padding:7px;"><?php echo $data5_bk_product_details->product_name; ?></td>
											</tr>
											<tr>
												<td style="padding:7px;"><b>Description</b></td>
												<td colspan="3" style="padding:7px;"><?php echo $data5_bk_product_details->product_description; ?></td>
											</tr>
											<tr>
												<td style="padding:7px;"><b>Product Included</b></td>
												<td style="padding:7px;">
													<?php echo $data5_bk_product_details->product_includes; ?>
												</td>
												<td style="padding:7px;"><b>Product Excluded</b></td>
												<td style="padding:7px;">
											...
											?>
											<tr>
												<td style="padding:7px;"><b>Optional Services</b></td>
											...
											?>
											<tr>
												<td style="padding:7px;"><b>Accommodation</b></td>
												<td colspan="3" style="padding:7px;">
													<table class="table">
														<tr>
															<td><b>Check In</b></td>
...
/*
					...
					$res12 = $this->db->query('select product_id, table_name, count(*) as cnt from tbl_booking_product where booking_id = \'' . $data_bk_NO->id . '\' ')->result();
							...
							<div class="row">
								<div class="table-responsive">
									<table class="table" border="1" style="border: 1px solid #eee;">
										<tr>
											<td style="padding:7px;"><b>Booking Policy</b></td>
									...
									?>
										...
										<tr>
											<td style="padding:7px;"><b>Cancellation Policy</b></td>
											<td colspan="3" style="padding:7px;">
												<?php
											//echo $data_bk_NO->id
								...
								<div class="table-responsive">
									<table class="table" border="1" style="border: 1px solid #eee;">
										<?php 
											...
											{
										?>
										<tr><td style="padding:7px;"><b>Name</b></td><td style="padding:7px;">
										<?php 
											echo $data8_bk_passenger->title.' '.$data8_bk_passenger->name.' '.$data8_bk_passenger->surname;
										?></td><td style="padding:7px;"><b>Mobile Phone</b></td><td style="padding:7px;"><?php echo $data8_bk_passenger->country_code.''.$data8_bk_passenger->phone_no; ?></td>
										<td style="padding:7px;"><b>Email Address</b></td><td style="padding:7px;"><?php echo $data8_bk_passenger->email; ?></td></tr>
										<?php 
											}
										?>
...
//echo $qry;
					...
					<div class="panel panel-default content">
						<div class="panel-heading" style="background:#66ffff;"><h5 style="font-weight:bold;margin:0px 1px;">Payment Details (Final Payment : <?php
											...
											?> <?php echo $data_bk_NO->grand_total; ?> )</h5></div>
						<div class="panel-body">
							<div class="row">
								<div class="table-responsive">
									<table class="table table-striped table-condensed" border="1" style="border: 1px solid #eee;">
										...
										<tr>
											...
											<td align="right" style="padding:7px;"><?php
											if($data_bk_NO->currency == "")
											{
												echo "MYR";
											}
						...
						<div class="panel-heading" style="background:#66ffff;">
							<div class="row" >
								<div class="table-responsive">
									<table class="table table-striped table-condensed" style="border: 1px solid #eee;margin-bottom:0px;">
										<tr>
											<td style="background:#66ffff;border:1px solid #66ffff;"><b>Payment Method</b></td>
											<td style="background:#66ffff;border:1px solid #66ffff;"><b>Charged to Credit Card</b></td>
										</tr>
									</table>
								</div>
								<!--div class="col-md-3">
