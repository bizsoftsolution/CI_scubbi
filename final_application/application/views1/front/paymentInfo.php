...
?>		 
		...
		<!--section class="dashboard-menu dashboard-menu-2 light-blue" style="margin: 60px 0 0 0;">
			...
			<form class="form-horizontal" action="<?php echo Ipay88::$epayment_url; ?>" method="POST" >
							 ...
							 Passenger Details</div>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
										  <input type="text" class="form-control" id="text" name="firstname[]" value="" required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-5" for="text">Surname:</label>
										<div class="col-sm-7">
										  <input type="text" class="form-control" id="text" name="lastname[]" value="" required>
										</div>
									</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-7">
												  <input type="email" class="form-control" id="text" name="email[]" value="" required>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-4" style="padding:0px;">
												 <input type="text" class="form-control" id="text" name="mobilenumber[]" value="" required>
												</div>
											</div>
							...
							<div class="panel panel-default">
							  ...
							  <div class="panel-body">
								<div class="row">
									...
									<?PHP
									//echo "dfbdj".$diveid;
									$cancellation = $this->db->get_where('tbl_cancellation_policies', array('user_id' => $diveid))->result();
									foreach($cancellation as $rowcancellation)
									{
										?><p style="padding:0% 1%;"><?php echo $rowcancellation->cancellation_name;?></p><?php
									}
									?>
...
<div class="row">
<div class="col-md-6">
<input type="checkbox" name="agree1" class="agree1" id="chkPassport"> I agree to the Cancellation Policy mentioned above and <a href="">Terms of Service.</a>
<br>
<input type="checkbox" name="agree2" id="chkPassport1"> I agree to receive SCUBBI's special offers and newsletter.
