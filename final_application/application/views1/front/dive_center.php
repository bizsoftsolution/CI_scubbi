...
$(document).ready(function(){
    $('input[type="checkbox"]').click(function(){
		...
		window.onbeforeunload = function (event) {
			...
			var message = 'teset?';
			  if (typeof event == 'undefined') {
				event = window.event;
				//jQuery.ajax({url:"<?php echo base_url(); ?>Front/clear", async:false});
				//$('#cart_details').html(data);
			  }
			  if (event) {
		...
		<?php
			...
			/* $data116 = $this->db->get('tbl_multicurrency')->result();
			$data6 = "";
			foreach($data116 as $dataval)
			{
				$data6 = $dataval->from_cur;
			} */
		?>
	</head>
	<style>
									...
									<li>
										<select id='display_currency' name="display_currency" style="margin: 38px 15px 0 0;width:100%;">
											...
											<?php 
												...
												{
											?>
												<option <?php if($this->session->userdata('dccurreny')){ if($this->session->userdata('dccurreny') == $data9_val->from_cur ){?>   selected="selected" <?php } } ?> value="<?php echo $data9_val->from_cur; ?>"><?php echo $data9_val->from_cur; ?></option>
											<?php 
												}
											?>
...
?>
                <a href="<?php echo base_url('Customer/allMessages');?>" ><i class="fa fa-envelope-o" style="color:#000;"><span class="badge badge-danger" style="background-color: red;position: absolute;top: 0px;left: 0px;"><?php if($notification != 0) { echo $notification; ?> <?php } else {	
					}?></span></i></a>
              </li> 
									<li>
...
<!--									<select id='' class="form-control">
		...
		<!--input type="hidden" value="<?php //echo $dc_cur; ?>" name="dc_cur" id="dc_cur"-->
		<script type="text/javascript">
			...
			/*  $(document).ready(function() {
				...
				$("#display").click(function() {                
				  ...
				  $.ajax({    //create an ajax request to display.php
					type: "GET",
					url: "<?php echo base_url(); ?>Front/get_dccur",             
					...
					//alert(dccurr);
					 $.ajax({
						...
						success: function(data) {
							...
							//location.reload();
							//alert(data);
							//if(confirm('Do you want change currency!!!')){
                        ...
                        <div class="">
						  ...
						  <form action="<?php echo base_url(); ?>Front/divecenterPopup" method="POST">
								<div class="form-group">
									...
									<input type="hidden" id="" class="form-control" style="height: 50px;width: 100%;" name="edate_popup" value="<?php echo $eDate; ?>">
									
									
									
									<input type="hidden" id="" class="form-control" style="height: 50px;width: 100%;" name="sdate_popup" value="<?php echo $sDate; ?>">
												...
												foreach ($data121 as $cval21)
												{
													...
													?>
																	...
																	if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
																	{
																		if($cval21->apply_promo_bulk_discount == "Yes")
																		{
																			...
																			if($amount > 0)
																			{
																				...
																				?>
																				<div class="col-md-4">
																					<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php //echo ucwords(strtoupper($divecenterval->dccurrency));?><?php if($this->session->userdata('dccurreny')!=""){echo $this->session->userdata('dccurreny');}else{echo "MYR";}?>&nbsp;&nbsp;<?php echo  number_format($newAmount,2); ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																				</div>
																				<?php
																			}
																			else
																...
																else
																{
																	...
																	?>
																	<div class="col-md-4">
																		<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php 
																		
																		//echo ucwords(strtoupper($divecenterval->dccurrency));?><?php if($this->session->userdata('dccurreny')!=""){echo $this->session->userdata('dccurreny');}else{echo "MYR";}?>&nbsp;&nbsp;<?php
																		echo number_format($newAmount,2); 
																		?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																	</div>																	
																	<?php
																}
																// End Render Product Line Detail
...
*/
    ...
    $CI =& get_instance();
  $result1 =   $CI->currencyConversation($Ndata121a , $daytype , '1' ,$no_of_persons,'courseRoomrates');
									...
									$accom = $result1['accom'];
										...
										//	 echo $disprice; 
																		...
																		?>
																		<div class="col-md-4">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php if($this->session->userdata('dccurreny')!=""){echo $this->session->userdata('dccurreny');}else{echo "MYR";}?>&nbsp;&nbsp;<?php echo $disprice; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
...
//																	}
													...
													?>
																...
																<?php
																	?>
																	<div class="col-md-3">
																	<a class="" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>" style="color:red;font-weight:bold;">UNAVAILABLE</a>
																</div>
																<div class="col-md-3">
																&nbsp;
																</div>	
...
$Ndata121 = $this->db->get_where('tbl_dcpackage', array('user_id' => $lesuiredive, 'product_status' => 'AVAILABLE','id' => $cval21->id))->result();
									...
									$CI =& get_instance();
									//$result123 =   $CI->packageRoomrates($Ndata121 , $daytype , '1' ,$no_of_persons);
									
									$result123 =   $CI->currencyConversation($Ndata121 , $daytype , '1' ,$no_of_persons , 'packageRoomrates' );
//var_dump($data121);
									...
									//	 echo $disprice; 
																		...
																		?>
																		<div class="col-md-3">
																			<a class="col-md-offset-2" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cval21->id; ?>"><b><?php if($this->session->userdata('dccurreny')!=""){echo $this->session->userdata('dccurreny');}else{echo "MYR";}?>&nbsp;&nbsp;<?php echo $disprice12; ?></b>&nbsp;&nbsp;Per&nbsp;&nbsp;<?php echo $cval21->product_unit;?></a>
																		</div>
			...
			text-shadow: 0 0 1px #F48F0A;
								...
								$e=0;
									...
									?>
										...
										$data3 = $this->db->get('tbl_review' , 1)->result();
