...
<div class="row">
	...
	<div class="panel panel-flat">
					 ...
					 <div class="form-group">
						<div class="row">
							...
							<div class="col-md-5">
								...
								<div class="col-md-8">
								   <input name="dailycapacity" class="form-control dailycapacity" type="text" required="" data-popup="tooltip" title="Enter the Daily Capacity of the Dives" data-placement="bottom">
								   <span class="help-block"></span>
								</div>
							</div>
						</div>                      
		...
		<label class="checkbox-inline">
		<input type="checkbox" class="styled" data-toggle="modal" data-target="#modal_theme_primary" name="dcaffiliation_padi" value="PADI">PADI</label>
		<!-- Basic modal -->
