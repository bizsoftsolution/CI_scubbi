    ...
    $('input[type="checkbox"]').click(function(){
        ...
        $("." + inputValue).toggle();
			...
			$(document).ready(function() {
				...
				/* $(document).on('click', '.optional_service', function() {
				...
				$(document).on('click', '.addCart', function() {
					...
					var inputElements = document.getElementsByClassName('optional_service');
...
?>
								...
								<a href="<?php echo base_url();?>Front/contactDiveCenter/<?php echo $dcid; ?>" class="btn btn-success" target="_blank"  style="height: 50px;line-height:35px;">Contact Dive Center</a>
