...
<div class="row">
   <div class="col-md-12">
	...
	<form name="add" method="POST" action="<?php echo  base_url();?>DCleisure/addNew" class="stepy-clickable form-horizontal form-validate-jquery" enctype="multipart/form-data">
