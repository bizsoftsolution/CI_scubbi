...
<div class="row">
   <div class="col-md-12">
		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li ><a href="<?php echo base_url(); ?>DCleisure/DCleisuredashboard" >Dashboard</a></li>
	...
	<form name="add" method="POST" id="custleisure" action="<?php echo  base_url();?>DCleisure/addNew" class="stepy-clickable form-horizontal form-validate-jquery" enctype="multipart/form-data">
	...
	<fieldset title="1">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
			   <input name="name" class="form-control" type="text" data-popup="tooltip" title="Product name(It is required field)" data-placement="bottom" required="" required>
	...
	<fieldset title="2">
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
			...
			<div class="col-md-9">
			   <input name="product_price" class="form-control" type="text" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="product_price" required="">
			   <span class="help-block"></span>
			</div>
		 </div>
		 <div class="form-group">
	...
	<input type="submit" name="submit_DCleisure_data" value="Add" class="btn btn-success stepy-finish">
</form>
						</div>
