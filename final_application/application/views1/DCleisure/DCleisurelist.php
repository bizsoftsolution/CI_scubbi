		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					...
					<li class="active"><a href="<?php echo base_url(); ?>DCleisure/DCleisurelist" >Add Standard Product</a></li>
      ...
      <!-- Traffic sources -->
        ...
        <table class="table datatable-button-print-columns">
            ...
            ?>
			  ...
			  <a href="<?php echo base_url(); ?>DCleisure/enable/<?php echo $row->id;?>"  title="Enable" class="btn bg-success remove" onclick="return confirm('Are You Sure want to Enable');"><!--i class="glyphicon glyphicon-remove "></i-->Enable</a>&nbsp;&nbsp;
             <!--a href="<?php echo base_url(); ?>DCleisure/disable/<?php echo $row->id;?>"  title="Disable" class="btn bg-danger remove" onclick="return confirm('Are You Sure want to Disable');">Disable</a>-->
              </td>
              </tr>
              <?php $i++;}?>
            </tbody>
