			   ...
			   enctype="multipart/form-data" id="guidedupd">
				...
				<legend class="text-semibold">General Info</legend>
					<div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="name" class="form-control" type="text" value="<?php echo $row->product_name; ?>" required="required">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="col-md-8">
											...
											<input type="hidden" name="tpdatestart" value="" id="dpd3" class="form-control" data-placement="bottom">
									...
									<div class="col-md-6">
										...
										<div class="col-md-8">
											...
											<input type="hidden" name="tpdateend" value="" id="dpd4" class="form-control" data-placement="bottom">
