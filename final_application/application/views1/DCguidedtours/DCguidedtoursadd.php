							...
							<div class="row">
								<div class="col-md-6">
									<label class="control-label col-md-3">Single Room</label>
									 <div class="col-md-6">
										<input name="single_room" class="form-control" type="text" data-popup="tooltip" title="Single Room(It is required field)" data-placement="bottom" id="pp1">
									</div>
								...
								<div class="col-md-6">
									<label class="control-label col-md-3">Twin Room</label>
									 <div class="col-md-6">
										<input name="twin_room" class="form-control" type="text" data-popup="tooltip" title="Twin Room(It is required field)" data-placement="bottom" id="pp2">
									</div>
									<div class="col-md-3"><span class="help-block"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<label class="control-label col-md-3">3 Person Room</label>
									 <div class="col-md-6">
										<input name="three_person_room" class="form-control" type="text" data-popup="tooltip" title="3 Person Room(It is required field)" data-placement="bottom" id="pp3">
									</div>
									<div class="col-md-3"><span class="help-block"><?php echo $dccur; ?>/PAX</span></div>
								</div>
								<div class="col-md-6">
									<label class="control-label col-md-3">Quad Room</label>
									 <div class="col-md-6">
										<input name="quad_room" class="form-control" type="text" data-popup="tooltip" title="Quad Room(It is required field)" data-placement="bottom" id="pp4">
									</div>
									<div class="col-md-3"><span class="help-block"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
