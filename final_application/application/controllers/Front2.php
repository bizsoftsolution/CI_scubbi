...
class Front extends CI_Controller
{
	...
	{	
		...
		//{
		$config['base_url'] = base_url('Front/search');
	...
	{
		$this->load->view('front/header');
		$this->load->view('front/customer_profile');
		$this->load->view('front/footer');
	}
	function customereditProfile()
	{
		$this->load->view('front/header');
		$this->load->view('front/customer_editprofile');
		$this->load->view('front/footer');
	}
	...
	{
		$data['tellmemore'] = $this->front_model->get_tellmemore();
