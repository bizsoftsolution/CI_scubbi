<?php
class DCReports extends CI_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->load->model('DCReportsModel');
...
*/
  ...
  {
    $data['salesReportsList']=$this->DCReportsModel->salesReportsList();
    $this->load->view('template/header');
    $this->load->view('template/sidebar');
    $this->load->view('reports/DCreportsList',$data);
    $this->load->view('template/footer');
  }
  function visitList()
  {
    $data['visitList']=$this->DCReportsModel->visitList();
    $this->load->view('template/header');
    $this->load->view('template/sidebar');
    $this->load->view('reports/DCvisitList',$data);
    $this->load->view('template/footer');
  }
  function dcvisitList()
	{
		$this->load->view('template/header');
		$this->load->view('template/sidebar');
		$this->load->view('reports/DCclickList');
		$this->load->view('template/footer');
	}
