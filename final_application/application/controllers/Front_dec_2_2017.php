...
function leisureProduct($data,$insert)
{
	...
	foreach($data as $row)
	{
		if($row->apply_promo == 'Yes')
		{
			...
			{
				$accom = "No";
				$disprice = $row->ap_discount_amount;
			}
			else
			{
				$accom = "No";
...
//									$output= $output.$rowcurrency->dccurrency.'&nbsp;&nbsp;';
											...
											<table class="table">
												<tr>
													<td style="width:20%;"><b>Product Description : </b></td>
													<td colspan="3">'.$row->product_description.' </td>
												</tr>
									...
									$output=$output.'</td>
										...
										$output=$output.'</td>
												...
												<tr>
													...
													//$output=$output.$row_optional_services.'<br>';	
															...
															//$output= $output.$rowcurrency->dccurrency.'&nbsp;'.$row_optional_services_price.'&nbsp;<input type="checkbox" name="optional_service_chk[]" value="'.$optional_concat_name[$j].'"/><br>';
																	...
																	<td><b>'.$row_optional_services_price.'</b><input type="hidden" name="optprd[]" value="' . $j . '/' . $option_service_name[$j] . '/' . $row_optional_services_price . '"></td>
																...
																//echo $option_service_qty_req[$j];
																		$output=$output.'
																		<td><input type="number" name="qty[]" style="width:50px;" min="0" value="1"/></td>';
																	}
																	else
																	{
												...
												<tr>
													...
													<td colspan="3">';
														$loglqdata .= "C Policy\n";						
														$output .= $this->renderBooking($row->cancellation_policy);
														$output=$output.'
													</td>
												</tr>';
			...
			// check product price.
									...
									If ($row->product_inclusive_accomodation == "Yes") {
										...
										if($row->apply_promo == 'Yes')
										{
											...
											if($cDate >= $promoStartDate && $cDate <= $promoEndDate)
											{
												$amt1 = explode(',',$row->apply_promo_single_room);
												$disprice = $amt1[0];
												//echo "1";
											}
											else
...
//												[' . $daytype . ']&nbsp;<b>' . $discurrency . '&nbsp;&nbsp;' .$disprice.'</b>';
											...
											<table class="table">
												...
												<tr>
													<td colspan="2">
													<span class="col-md-2 col-sm-6"><b>Diver Level : </b></span>
													<span class="col-md-2 col-sm-6">';
														if($row->diver_experience != '')
														{
															$diver_level = explode(',',$row->diver_experience);
															foreach($diver_level as $row_diver_level)
															{
																$output=$output.$row_diver_level.' , ';	
															}
													...
													<span class="col-md-2 col-sm-6"><b>Diver Skill</b></span>
													<span class="col-md-2 col-sm-6" > ';
													...
													<span class="col-md-2 col-sm-6" ><b>Diver Specialties</b></span>
													<span class="col-md-2 col-sm-6" >';
														if($row->diver_specialties != '')
														{
															...
															{
																$output=$output.$row_diver_specialties.' , ';	
															}
														} 
														else
														{
												...
												<tr>
													<td><span class="col-md-6"><b>Included</b></span>
													<span class="col-md-6">';
													if($row->product_include_display =="TRUE")
													{
														if($row->product_includes != '')
													...
													<td><span class="col-md-6"><b>Excluded</b></span>
													<span class="col-md-6">';
													if($row->product_exclude_display =="TRUE")
													{
														if($row->product_excludes != '')
												...
												<tr>
													<td colspan="2">
														<span class="col-md-4"><b>Optional Service : </b></span>
														<span class="col-md-8">';
												...
												<tr>
													...
													<h3>Accomodations </h3>
														<table class="table">
															...
															<tr>
																<td>
																	<input type="radio" name="accommodation_type" value="1" checked>Single
																</td>
																<td>';
																	$output=$output.$row->oneperson_bed_type.'
																</td>
																<td>
																	Check in
																</td>
																<td>';
																$output=$output.$row->checkintime.'
																</td>
															</tr>
															<tr>
																<td>
																	<input type="radio" name="accommodation_type" value="2" ' . ($insert['noofPerson'] <2 ? 'disabled':'') .'>Twin Sharing
																</td>
																<td>';
																	$output=$output.$row->twoperson_bed_type.'
																</td>
																<td>
																	Check out
																</td>
																<td>';
																$output=$output.$row->checkouttime.'
																</td>
															</tr>
															<tr>
																<td>
																	<input type="radio" name="accommodation_type" value="3" ' . ($insert['noofPerson'] <3 ? 'disabled':'') .'>Tripple Sharing
																</td>
																<td>';
																	$output=$output.$row->threeperson_bed_type.'
																</td>
																<td>
																	Accomodation Type
																</td>
																<td>';
																$output=$output.$row->actype.'
																</td>
															</tr>
															<tr>
																<td>
																	<input type="radio" name="accommodation_type" value="4" ' . ($insert['noofPerson'] <4 ? 'disabled':'') .'>Quad Sharing
																</td>
																<td>';
																	$output=$output.$row->fourperson_bed_type.'
																</td>
																<td>
																	&nbsp;
																</td>
															...
															<tr>
																<td>
																	<input type="radio" name="accommodation_type" value="9" >' . $custom_room .'
																</td>
																<td>
																Special
																</td>
															...
															<tr>
																...
																<td colspan="3">';
																	$accommodation_facilities1 = explode(',',$row->accommodation_facilities);
...
//										. $discurrency . '&nbsp;&nbsp;' .$disprice.'</b>';
									...
									<table class="table">
										<tr>
											<td>
												<span class="col-md-4"><b>Product Description</b></span>
												<span class="col-md-8">'.$row->product_description.'</span>
											</td>
										</tr>
										';
										if($row->dive_sites != "")
										{
											...
											<tr>
												<td>
													<span class="col-md-4"><b>DIVE SITES</b></span>
													<span class="col-md-8">
													';
										...
										<tr>
											<td>
												<span class="col-md-4">
													...
													{
															$output=$output.'Diver Level is not provided for this product';
													}
													$output=$output.'
												</span>
												<span class="col-md-4">
													...
													{
															$output=$output.'Diver Skill is not provided for this product';
													}
													$output=$output.'
												</span>
												<span class="col-md-4">
													<b>Diver Specialties</b><br>';
													if($row->diver_specialties != "")
													{	
														$diver_specialties1 = explode(',',$row->diver_specialties);
														foreach($diver_specialties1 as $row_diver_specialties)
													...
													{
															$output=$output.'Diver Specialties is not provided for this product';
													}
													$output=$output.'
												</span>
											</td>
										...
										if($row->optional_services == 'Yes')
										{
											...
											<td>
												...
												<table class="table">
													...
													<tr>
														<td><input type="radio" name="accommodation_type" value="1" checked>Single</td>
														<td>'.$row->oneperson_bed_type.'</td>
														<td>check in</td>
														<td>'.$row->checkintime.'</td>
													</tr>
													<tr>
														<td><input type="radio" name="accommodation_type" value="2" ' . ($insert['noofPerson'] <2 ? 'disabled':'') .'>Twin Sharing</td>
														<td>'.$row->twoperson_bed_type.'</td>
														<td>check Out</td>
														<td>'.$row->checkouttime.'</td>
													</tr>
													<tr>
														<td><input type="radio" name="accommodation_type" value="3" ' . ($insert['noofPerson'] <3 ? 'disabled':'') .'>Tripple Sharing</td>
														<td>'.$row->threeperson_bed_type.'</td>
														<td>Accomodation Type</td>
														<td>'.$row->actype.'</td>
													</tr>
													<tr>
														<td><input type="radio" name="accommodation_type" value="4" ' . ($insert['noofPerson'] <4 ? 'disabled':'') .'>Quad Sharing</td>
														<td>'.$row->fourperson_bed_type.'</td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td><input type="radio" name="accommodation_type" value="9" >' . $custom_room .'</td>
														<td>Special</td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
													</tr>';
													...
													$output=$output.'	
														<tr>
															<td colspan="2"><b>Facilities</b></td>
															<td colspan="2">';
																$accommodation_facilities1 = explode(',',$row->accommodation_facilities);
																foreach($accommodation_facilities1 as $row_accommodation_facilities)
																{
										...
										$output=$output.'	
											<tr>
												<td>
													<span class="col-md-4"><b>Other Information</b></span>
													<span class="col-md-8">'.$row->other_info.'</span>
												</td>
											</tr>';
											}
											if($row->booking_policy != 0)
											{
												...
												<tr>
													<td>
													<span class="col-md-4"><b>Booking Policy</b></span>
													<span class="col-md-8">
													';
											...
											if($row->cancellation_policy != 0)
											{
												...
												<tr>
													<td>
													<span class="col-md-4"><b>Cancellation Policy</b></span>
													<span class="col-md-8">
													';
					...
					//'no_of_rooms'=>$no_of_rooms_person
								...
								if ($this->input->post('accom') == "Yes") {
									...
									$this->db->select('*');
									$this->db->from('tbl_dcroomrates');
									$this->db->where('table',$this->input->post('table_name'));
									$this->db->where('prodid',$this->input->post('product_id'));
									$this->db->where('season',$this->input->post('daytype'));
									$qrm = $this->db->get();
									$resrm = $qrm->result();
									if ($qrm->num_rows() > 0)
									{
			...
			// Accomodation List
		 	...
		 	// $this->db->where('sessionid',$this->sessid);
				...
				foreach($resacc as $arow1)
				{
					...
					<td style="padding:3px;" colspan="2">Accom.(' . $arow1->season .')</td>
					<td style="padding:3px;" colspan="2">';
					switch($arow1->accom_basis) {
						case 1:
						$resultOutput .= ' Single Rm';
						break;
						case 2:
						$resultOutput .= ' Twin Rm';
						break;
						case 3:
						$resultOutput .= ' Triple Rm';
						break;
						case 4:
						$resultOutput .= ' Quad Rm';
						break;
					}
