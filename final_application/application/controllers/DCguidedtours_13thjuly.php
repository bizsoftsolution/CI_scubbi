	...
	if($this->input->post('Update_DCguidedtours_Data'))
		{  
            ...
            $userData = array(
				...
				'actype' => $this->input->post('actype'),
				'amenities' => $this->input->post('amenities'),
				'diver_certification' => implode(",", (array)$divercertification),
				'diver_experience' => implode(",", (array)$diverexperience),
				'diver_specialties' => implode(",", (array)$diverspecialties),				
