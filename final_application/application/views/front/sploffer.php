	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="load-more-btn" >
			<p style="border:1px solid #777;">
				<a class="" href="" id="load_more" data-val="0">Click to show more...</a>
				<!--button class="btn-default"> View All Offers<i class="fa fa-angle-right"></i> </button->
			</p>
		</div>
	</div>
			<!--button class="btn" id="load_more" data-val = "0">Load more.. </button->
		</div>
...
<script>
    ...
    var getcountry = function(page){
        $("#loader").show();
        $.ajax({
            url:"<?php echo base_url() ?>Front/getViewmoreSpecialoffer",
            type:'POST',
            data: {page:page}
   ...
   /*  var scroll  = function(){
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="load-more-btn" >
                <p style="border:1px solid #777;">
                    <a href="<?php echo base_url(); ?>Front/get_Allspecialoffer" class="">Click to show more...</a>
                    <!--button class="btn-default"> View All Offers<i class="fa fa-angle-right"></i> </button-->
                </p>
            </div>
        </div>
