							...
							?>
								...
								<div class="row">
									<div class="col-md-10" style="padding: 10px;background-color: #9ae487;border-radius: 11px;margin:15px 0px;">
										...
										<span class="listing-desc-date" style="float: right;color: #fff;font-weight: bold;"><i class="fa fa-calendar"></i><span  class="testDt" value=<?php echo strtotime($converList->time) * 1000; ?>></span> </span>
									 </div>		
									<div class="col-md-2">
									<?php 
								...
								<div class="row">
									<div class="col-md-2">
										<?php 
										if ($converList->from == 33) {
									?>
										<img src="<?php echo base_url(); ?>/upload/customerprofile/user.png" alt="" class="profile-img img-responsive" />
