							 ...
							 <div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
								   ...
								   <div class="login-box-inner">
										...
										<div class="row">
											<div class="col-md-3">
												<img src="<?php echo base_url(); ?>upload/DCprofile/<?php echo $divecenterval->dcimage; ?>" class="img-responsive" style="display:block;margin:0 auto;"/>
												<p><?php echo $divecenterval->dcname; ?></p>
											</div>
											<div class="col-md-9">
												 <form action="<?php echo base_url(); ?>Front/divecenterPopup" method="POST">
													<div class="form-group">
														<div class="row">
															...
															<div class="col-md-6">
																<input type="text" class="form-control" id="sdate" value="<?php echo $sDate; ?>" name="sdate_popup" style="margin: 0px 0 15px 0;">
															</div>
															<div class="col-md-6">
																<input type="text" class="form-control" id="edate" name="edate_popup" value="<?php echo $eDate; ?>">
																<input type="hidden" name="diveid_popup" value="<?php echo $d_id; ?>">
																<input type="hidden" name="dcid_popup" value="<?php echo $divecenterval->user_id; ?>">
																<input type="hidden" name="dcfrom_popup" value="<?php echo $divecenterval->dcname; ?>">
															</div>
														</div>
													...
													<div class="form-group">
														<div class="row">
														<div class="col-md-12">
															<label for="email">No. of Person:</label>
														</div>
														<div class="col-md-12">
															<input type="text" class="form-control" id="nop_popup" name="nop_popup" value="<?php echo $no_of_persons; ?>">
														</div>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<div class="row">
														<div class="col-md-12">
															<textarea class="form-control" rows="10" name="messages_popup" placeholder="Write your message here."></textarea>
													...
													<div class="form-group">
													 <div class="row">
														<div class="">
															<div class="col-md-6">
																 <input type="submit" class="btn btn-danger col-xs-12" value="Send Message" name="submit_divecenter_data" style="margin: 0px 0 15px 0;">
															</div>
															<div class="col-md-6">
									...
									<div class="col-md-12">
										<form class="form-inline" role="form" action="<?php echo base_url(); ?>Front/divecenter_search" method="POST">
											...
											<div class="form-group">
												...
												<a href="#" data-toggle="modal" data-target=".login-model" class="btn btn-success" style="height: 50px;line-height:35px;">Contact Dive Center </a>
