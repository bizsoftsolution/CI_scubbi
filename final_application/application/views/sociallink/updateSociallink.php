      ...
      <div class="panel panel-flat">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-8">
               ...
               <?php } ?>
               <?php foreach($sociallink as $row){?>
               <form name="add"   method="POST" action="<?php echo  base_url();?>Sociallink/editData/<?php echo $row->id;?>" class="form-horizontal">
				  <div class="form-body">
                     <div class="form-group">
                        <label class="control-label col-md-3">Link Name</label>
                        <div class="col-md-9">
                           <input name="edit_name" class="form-control" type="text" value="<?php echo $row->name;?>">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="edit_link" class="form-control" type="text" value="<?php echo $row->links;?>">
                           <span class="help-block"></span>
                        </div>
                     </div>
                  </div>
