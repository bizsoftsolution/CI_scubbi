      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
            ...
            <div style="text-align:right;">
               ...
               <a href="<?php echo  base_url();?>SAleisure/SAleisuredashboard" class="btn bg-pink"><i class="glyphicon glyphicon-refresh"></i> List</a>
            </div>
            <hr/>
         </div>
         ...
         <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <hr>
                                <form name="add" method="POST" action="<?php echo  base_url();?>SAleisure/edit/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery" enctype="multipart/form-data" id="custom">
                                    ...
                                    <fieldset title="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="sequence_number" class="form-control" type="number" value="<?php echo $row->sequence_number; ?>" required min="1">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
							...
							if(text_box.hasAttribute('readonly')){    
								...
								text_box.setAttribute('readonly', 'readonly');    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="product_price" id="product_price" class="form-control" type="number" value="<?php echo $row->product_price; ?>" >
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        ...
                                        <!--****************************************************************************************************************************************************************************************************************************************************************************************************													START APPLY DISCOUNT FOR BULK PURCHASE *****************************************************************************************************************************************************************************************************************************************************************************************************-->
														...
														<input type="text" class="rangecheck" name="rangecheck">
															<input type="text" name="startrange[]" style="width:50px;" class="startrange" value="<?php echo $arr_strrange1[$i];?>" id="startrange-<?php echo $j; ?>"> TO
															<input type="text" name="endrange[]" style="width:50px;" class="endrange" id="endrange-<?php echo $j; ?>" value="<?php echo $arr_endrange1[$i]; ?>"> DISCOUNT:
														...
														<input type="hidden" value="<?php echo $j; ?>" id="rangeValue"/>
														...
														<?php
																				...
																				?>
																				<input type="text" class="rangecheck" name="rangecheck">
                                                                                <input type="text" name="startrange[]" style="width:50px;" class="startrange" id="startrange-1"/> TO
                                                                                <input type="text" name="endrange[]" style="width:50px;" id="endrange-1" class="endrange" value="0" /> DISCOUNT :
																				...
																				<input type="hidden" value="1" id="rangeValue"/>
                                                                    ...
                                                                    $(document).on("keyup", "input:text.field_name", function() {
																		...
																		if(amt > 0.00)
																		{
																			...
																			if (type == 'PERCENT') {
																				...
																				{
																					$(this).closest('div').find('.discountrate').val(0.00);
																				}
                                                            ...
                                                            <script type="text/javascript">
                                                                ...
                                                                $(document).ready(function() {
                                                                    ...
                                                                    var wrapper = $('.field_wrapper'); //Input field wrapper
																	 ...
																	 var no = $('#rangeValue').val() + 1;
                                                                    var x = 1; //Initial field counter is 1
                                                                    $(addButton).click(function() { //Once add button is clicked
																	
																	var fieldHTML = '<div><input type="text" name="startrange[]" style="width:50px;" class="startrange" id="startrange-'+no+'"> TO <input type="text" name="endrange[]" style="width:50px;" id="endrange-'+no+'" class="endrange" > DISCOUNT : <input type="text" class="field_name" name="field_name[]" value="0" style="width:50px;"/>RATE :<input type="text" class="discountrate" style="width:50px;" name="discount_bulk_purchase_amount[]" readonly><a href="javascript:void(0);" class="remove_button" title="Remove field"><i class="fa fa-remove" style="color:red;font-size:20px;"></i></a></div>';
                                                                    ...
                                                                    $(document).ready(function() {
                                                                        ...
                                                                        $(document).on("keyup", "input:text.apdiscountrate", function() {
                                                                            ...
                                                                            if (type == 'PERCENT') {
																				...
																				{
																					$(this).parent().parent().parent().parent().closest('div').find('#afterpromo_discount').val(0);
																				}
                                                                            } else {
							...
							if ($("#dcdiscountpurchaseYes").is(":checked"))
							{
								...
								if (type == 'PERCENT') 
								{
				                    ...
				                    var fi1 = dis1[i] - dis1[i] * disrate / 100;
										...
										{
											$(wrapper).append('<div class="form-group" style="margin-bottom: 3px;margin-top: 5px;"><label class="control-label col-md-3"></label><div class="col-md-9"><div class="col-md-12"><table class="table" style="background: lightblue;"><tr><td>Range</td><td><input type="text" value="'+values[i]+'" readonly></td><td>To</td><td><input type="text" value="'+r2+'" readonly></td><td><input type="text" value="0" name="apbdl[]" readonly></td></tr></table></div></div></div>');
										}
									}
								}
								else
						...
						function enable_cb2() {
						  if (this.checked) {
							...
							//$(".divecertf1").prop('checked', false);
                                    ...
                                    <input type="submit" name="update_SAleisure_data" value="Update" class="btn btn-success stepy-finish">
