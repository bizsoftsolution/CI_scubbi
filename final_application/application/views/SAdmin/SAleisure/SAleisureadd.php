...
<input type="text" class="rangecheck" name="rangecheck">
                                                                                ...
                                                                                <input type="text" name="endrange[]" style="width:50px;" class="endrange" id="endrange-1" value="0"  /> DISCOUNT :
		...
		<legend class="text-semibold">Other Details</legend>
                                                        ...
                                                        <input type="submit" name="submit_SAleisure_data" value="Add" class="btn btn-success">
                                                    </form>
                                                </div>
