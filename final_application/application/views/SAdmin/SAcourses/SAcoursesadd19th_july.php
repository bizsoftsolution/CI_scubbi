		  ...
		  <hr style="width:100%;">
						...
						<div class="field_wrapper">
							<tr id="1">
								...
								<div class="table-responsive" style="background:lightblue;margin:2px 0 0 0;">
									<table class="table">
										<tr><td>Range : </td><td><input type="text" disabled class="str"></td> <td>to </td><td><input type="text" disabled class="end"></td></tr>
			...
			<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					var fieldHTML = '<div><input type="text" name="startrange[]" style="width:50px;" class="startrange"> TO <input type="text" name="endrange[]" style="width:50px;" class="endrange"  > DISCOUNT RATE : <input type="text" class="field_name" name="field_name[]" value="" style="width:50px;"/><a href="javascript:void(0);" class="remove_button" title="Remove field"><i class="fa fa-remove" style="color:red;font-size:20px;"></i></a><div class="table-responsive" style="background:lightblue;margin:2px 0 0 0;"><table class="table"><tr><td>Range : </td><td><input type="text" disabled class="str"></td> <td>to </td><td><input type="text" disabled class="end"></td></tr><tr><td>Normal Rate</td><td>Weekend Rate</td><td>Peak Season Rate</td><td>Super Peak Season Rate</td></tr><tr><td><input type="text" style="width:50px;" class="dcr1">myr/pax</td><td><input type="text" style="width:50px;" class="dcr2">myr/pax</td><td><input type="text" style="width:50px;" class="dcr3">myr/pax</td><td><input type="text" style="width:50px;" class="dcr4">myr/pax</td></tr></table></div></div>'; //New input field html 
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					var fieldHTML = '<div><input type="text" name="startrange[]" style="width:50px;" class="startrange"> TO <input type="text" name="endrange[]" style="width:50px;" class="endrange"  > DISCOUNT RATE : <input type="text" class="field_name" name="field_name[]" value="" style="width:50px;"/><a href="javascript:void(0);" class="remove_button3" title="Remove field"><i class="fa fa-remove" style="color:red;font-size:20px;"></i></a><div class="table-responsive" style="background:lightblue;margin:2px 0 0 0;"><table class="table"><tr><td>Range : </td><td><input type="text" disabled class="str"></td> <td>to </td><td><input type="text" disabled class="end"></td></tr><tr><td>Normal Rate</td><td>Weekend Rate</td><td>Peak Season Rate</td><td>Super Peak Season Rate</td></tr><tr><td>single room</td><td><input type="text" style="width:50px;" class="dcr1">myr/pax</td><td><input type="text" style="width:50px;" class="dcr2">myr/pax</td><td><input type="text" style="width:50px;" class="dcr3">myr/pax</td><td><input type="text" style="width:50px;" class="dcr4">myr/pax</td></tr><tr><td>twin room</td><td><input type="text" style="width:50px;" class="dcr5">myr/pax</td><td><input type="text" style="width:50px;" class="dcr6">myr/pax</td><td><input type="text" style="width:50px;" class="dcr7">myr/pax</td><td><input type="text" style="width:50px;" class="dcr8">myr/pax</td></tr><tr><td>3 person room</td><td><input type="text" style="width:50px;" class="dcr9">myr/pax</td><td><input type="text" style="width:50px;" class="dcr10">myr/pax</td><td><input type="text" style="width:50px;" class="dcr11">myr/pax</td><td><input type="text" style="width:50px;" class="dcr12">myr/pax</td></tr><tr><td>quad room</td><td><input type="text" style="width:50px;" class="dcr13">myr/pax</td><td><input type="text" style="width:50px;" class="dcr14">myr/pax</td><td><input type="text" style="width:50px;" class="dcr15">myr/pax</td><td><input type="text" style="width:50px;" class="dcr16">myr/pax</td></tr></table></div></div>'; //New input field html 
					var x = 1; //Initial field counter is 1
					$(addButton).click(function() { //Once add button is clicked
						if (x < maxField) { //Check maximum number of input fields
							x++; //Increment field counter
