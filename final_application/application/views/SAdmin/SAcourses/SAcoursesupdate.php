				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							...
							<div class="col-md-2"> 
							<input name="custom_room[]" class="form-control cr" type="number" value="<?php echo $arr_p_i_a_c[0]; ?>" id="pp17" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="custom_room[]" class="form-control cr" type="number" value="<?php echo $arr_p_i_a_c[1]; ?>" id="pp18" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="custom_room[]" class="form-control cr" type="number" value="<?php echo $arr_p_i_a_c[2]; ?>" id="pp19" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="custom_room[]" class="form-control cr" type="number" value="<?php echo $arr_p_i_a_c[3]; ?>" id="pp20" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						</div>
					</div>
				 ...
				 <div class="dcinclusiveaccomodationBox1" style="display:none;background:#eeeeee;padding:0% 3%;">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp17" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp18" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp19" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp20">
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
