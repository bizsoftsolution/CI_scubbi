      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
           ...
           <div style="text-align:right;">
              <a class="btn bg-purple" href="<?php echo  base_url();?>SAtellmemore/addNew"><i class="glyphicon glyphicon-plus"></i> Add </a>
         ...
         <table class="table datatable-button-print-columns">
            ...
            ?>
              ...
              <td><?php echo $row->diving_centers; ?></td>
