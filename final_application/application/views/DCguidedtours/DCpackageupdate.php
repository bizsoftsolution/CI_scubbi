					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
						   ...
						   <?php echo ($chkbox1=='Available')?'checked':'' ?> >AVAILABLE</label>
							...
							<?php echo ($chkbox1=='Hidden')?'checked':'' ?> checked>HIDDEN</label>
                        </div>
                     </div>
				</fieldset>
				<fieldset title="2">
				<legend class="text-semibold">Pricing Options</legend>
					<div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <input name="productmaxday" class="form-control" type="text" value="<?php echo ($row->product_max_day == 'No Limit' ? '' : $row->product_max_day ); ?>">
                           <span class="help-block"></span>
                        </div>
						<div class="col-md-2">
							<label class="checkbox-inline"><input type="checkbox" class="styled" id="nolimit" name="productmaxday" value="No Limit" <?php echo ($row->product_max_day == 'No Limit' ? 'checked' : '' ); ?>>NO LIMIT</label>
						</div>
			<script>
