               ...
               <form name="add"   method="POST" action="<?php echo  base_url();?>Promo_code/editPromo/<?php echo $promo_id; ?>" class="form-horizontal ">
				  ...
				  ?>
					<div class="form-group col-md-4">
					  <label class="control-label col-md-6"><b>Promo Code</b> <strong style="color:red;">*</strong>
					  </label>
					  <div class="col-md-6">                      
						<input type="text" name="promo_code" readonly="" class="form-control" id="promo_code" value="<?php echo $cDet->promo_code;?>">
						<span class="help-block"></span>
					  </div>
					</div>
					
					<div class="form-group col-md-4">
					  <label class="control-label col-md-6"><b>Total count</b> <strong style="color:red;">*</strong>
					  </label>
					  <div class="col-md-6">                      
						<input type="text" name="total_count" class="form-control" id="total_count" value="<?php echo $cDet->total_count;?>">
						<span class="help-block"></span>
					  </div>
					</div>
					<div class="form-group col-md-4">
					  <label class="control-label col-md-6"><b>Balance count</b> <strong style="color:red;">*</strong>
					  </label>
					  <div class="col-md-6">                      
						<input type="text" name="used_count" class="form-control" id="used_count" value="<?php echo $bc = $cDet->total_count - $cDet->used_count;?>" readonly>
						<span class="help-block"></span>
					  </div>
					</div>
