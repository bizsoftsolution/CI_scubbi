		...
		<div class="panel-body">
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li class="active" ><a href="<?php echo base_url(); ?>DCavailabiltycalendar" >Availability Calendar</a></li>
					<!--li><a href="<?php echo base_url(); ?>DCavailabiltycalendar/dayCal" >Special Dates</a></li-->
				</ul>
