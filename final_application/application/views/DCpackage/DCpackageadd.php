		...
		<div class="form-group">
					...
					$(".sequence_number").on("input", function(evt) {
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="sequence_number" class="form-control sequence_number" type="number"  data-popup="tooltip" title="Sequence Number(It is required field)" data-placement="bottom" required="" min="1">
                           <span class="help-block"></span>
                        </div>
                     </div>
					 <div class="form-group">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input  min= "0" name="product_normal_price" class="form-control nr" type="number" value="1" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp1">
							</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="col-md-9" style="padding:0px;">
							<input  min= "0" name="product_weekend_price" class="form-control wr" type="number" value="1" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp2">
							</div>
							<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						</div>
					</div> 
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="col-md-9" style="padding:0px;">
							<input  min= "0" name="product_peakseason_price" class="form-control psr" type="number" value="1" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp3">
							</div>
							<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="col-md-9" style="padding:0px;">
							<input  min= "0" name="product_super_peakseason_price" class="form-control spsr" type="number" value="1" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp4">
							</div>
							<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						</div>
					</div>
		 ...
		 <div class="dcinclusiveaccomodationBox1" style="display:none;background:#eeeeee;padding:0% 1%;">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<div class="row">
						<div class="col-md-2"> 
						<input  min= "0" name="twin_room[]" class="form-control tr" type="number" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp5" >
						</div>
						<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						<div class="col-md-2"> 
