      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
           ...
           <div style="text-align:right;">
              <a class="btn bg-purple" href="<?php echo  base_url();?>Divecenter/addNew"><i class="glyphicon glyphicon-plus"></i> Add </a>
         ...
         <table class="table datatable-button-print-columns">
            ...
            ?>
              ...
              <a href="<?php echo base_url(); ?>Divecenter/editData/<?php echo $row->dive_center_id;?>" title="Edit" class="btn bg-success"><i class="glyphicon glyphicon-pencil "></i>
              </a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>Divecenter/deleteData/<?php echo $row->dive_center_id;?>"  title="Delete" class="btn bg-danger remove" onclick="return confirm('Are You Sure to delete');"><i class="glyphicon glyphicon-remove "></i></a>
              </td>
              </tr>
              <?php $i++;}?>
