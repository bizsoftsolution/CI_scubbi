        ...
        ?>
			<div class="tabbable">
				<ul class="nav nav-tabs nav-tabs-highlight">
					<li class="active"><a href="<?php echo base_url(); ?>DCcourses/DCcoursesdashboard" >Dashboard</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="basic-tab1">
							<table class="table datatable-button-print-columns">
								...
								<?php
								$i=1;
								  foreach($DCcoursesdashboard as $row) {
								?>
								  <tr>
								  ...
								  <a href="<?php echo base_url(); ?>DCcourses/edit/<?php echo $row->id;?>" title="Edit" class="btn bg-success"><i class="glyphicon glyphicon-pencil "></i>
								  </a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>DCcourses/delete/<?php echo $row->id;?>"  title="Delete" class="btn bg-danger remove" onclick="return confirm('Are You Sure to delete');"><i class="glyphicon glyphicon-remove "></i></a>
								  </td>
								  </tr>
								  <?php $i++;}?>
								</tbody>
						...
						<div class="tab-pane" id="basic-tab2">
							...
							$que = $this->db->get('tbl_dccourses')->result();
							?>
							<table class="table datatable-button-print-columns">
								<thead>
								   <tr>
								...
								?>
								  ...
								  <td style="text-align:right">
									  <a href="<?php echo base_url(); ?>DCcourses/enableProduct/<?php echo $row1->id;?>" title="Edit" class="btn bg-success">ENABLE</a>
								  </td>
								  </tr>
								  <?php $i++;}?>
								</tbody>
