                    ...
                    <div class="panel-body">
                        <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-highlight">
                                <li><a href="<?php echo base_url(); ?>DCcourses/DCcoursesdashboard">Dashboard</a>
                                </li>
                                <li><a href="<?php echo base_url(); ?>DCcourses/DCcourseslist">Add Standard Product</a>
                                </li>
                                <li class="active"><a href="<?php echo base_url(); ?>DCcourses/addNew">Add Customized Product</a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="panel-body1">
                                                    ...
                                                    <?php //redirect(base_url(). 'slider/sliderList'); 
													} ?>
													  <?php foreach($getEditdata as $row){?>
                                                    <form name="add" method="POST" action="<?php echo  base_url();?>DCcourses/edit/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery" enctype="multipart/form-data" id="custom">
