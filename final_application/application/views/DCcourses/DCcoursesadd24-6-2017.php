...
<div class="row">
   <div class="col-md-12">
	...
	<form name="add" method="POST" action="<?php echo  base_url();?>DCcourses/addNew" class="stepy-clickable form-horizontal" enctype="multipart/form-data"> <!--class ="form-validate-jquery"-->
		  ...
		  <div class="form-group">
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
				...
				<div class="col-md-9">
				   <input name="sequence_number" class="form-control sequence_number" type="text"  data-popup="tooltip" title="Sequence Number(It is required field)" data-placement="bottom" min="1">
				   <span class="help-block"></span>
				</div>
			 </div>
			 <div class="form-group">
	...
	<fieldset title="2">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-9">
			   <input name="maxdiveday" class="form-control" type="text"  data-popup="tooltip" title="Max Dive(It is required field)" data-placement="bottom">
			   <span class="help-block"></span>
			</div>
		 </div>
		  <div class="form-group">
