      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
            ...
            <div style="text-align:right;">
               ...
               <a href="<?php echo  base_url();?>DCcourses/DCcoursesdashboard" class="btn bg-pink"><i class="glyphicon glyphicon-refresh"></i> List</a>
            </div>
            <hr/>
         </div>
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <?php foreach($getEditdata as $row){?>
				...
				<hr>
				<form name="add" method="POST" action="<?php echo  base_url();?>DCcourses/edit/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery" 
...
*/
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input name="sequence_number" class="form-control" type="text" value="<?php echo $row->sequence_number; ?>" required min="0">
                           <span class="help-block"></span>
                        </div>
                     </div>
					 <div class="form-group">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input name="product_normal_price" class="form-control nr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp1" min="0" readonly >
									</div>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="col-md-9" style="padding:0px;">
									<input name="product_weekend_price" class="form-control wr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp2" min="0"  readonly >
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div> 
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="col-md-9" style="padding:0px;">
									<input name="product_peakseason_price" class="form-control psr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp3"  min="0" readonly >
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="col-md-9" style="padding:0px;">
									<input name="product_super_peakseason_price" class="form-control spsr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom"  min="0" id="pp4" readonly >
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label for="email">Normal Rate</label>
									<div class="col-md-9" style="padding:0px;">
									<input name="product_normal_price" class="form-control nr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp1"  min="0"  value="<?php echo $row->product_normal_rate; ?>">
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="email">Weekend Rate</label>
									<div class="col-md-9" style="padding:0px;">
									<input name="product_weekend_price" class="form-control wr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp2" min="0"  value="<?php echo $row->product_weekend_rate; ?>">
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div> 
							<div class="col-md-3">
								<div class="form-group">
									<label for="email">Peak Season Rate</label>
									<div class="col-md-9" style="padding:0px;">
									<input name="product_peakseason_price" class="form-control psr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="pp3"  min="0" value="<?php echo $row->product_peakseason_rate; ?>">
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="email">Super Peak Season Rate</label>
									<div class="col-md-9" style="padding:0px;">
									<input name="product_super_peakseason_price" class="form-control spsr" type="number"  data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom"  min="0" id="pp4" value="<?php echo $row->product_superpeak_rate; ?>">
									</div>
									<div class="col-md-3"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								</div>
							</div>
...
*****************************************************************************************************************************************************************************************************************************************************************************************************-->				
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0" value="<?php echo $arr_p_i_a_s[0]; ?>" id="pp01" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0" value="<?php echo $arr_p_i_a_s[1]; ?>" id="pp02" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number" min="0"  value="<?php echo $arr_p_i_a_s[2]; ?>" id="pp03" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0" value="<?php echo $arr_p_i_a_s[3]; ?>" id="pp04" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>	
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0" value="<?php echo $arr_p_i_a_t[0]; ?>" id="pp5" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0" value="<?php echo $arr_p_i_a_t[1]; ?>" id="pp6" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0" value="<?php echo $arr_p_i_a_t[2]; ?>" id="pp7" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0" value="<?php echo $arr_p_i_a_t[3]; ?>" id="pp8" ">
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>	
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-2"> 
							<input min="0"  name="product_inclusive_accomodation_threeperson[]" class="form-control tpr" type="number" 
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number" min="0"  value="<?php echo $arr_p_i_a_q[0]; ?>" id="pp13" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number"  min="0" value="<?php echo $arr_p_i_a_q[1]; ?>" id="pp14">
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number"  min="0" value="<?php echo $arr_p_i_a_q[2]; ?>" id="pp15" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
							<input  min="0" name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number" value="<?php echo $arr_p_i_a_q[3]; ?>" id="pp16">
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="row">
							...
							<div class="col-md-2"> 
							<input name="custom_room[]" class="form-control cr" type="number" min="0" value="<?php echo $arr_p_i_a_c[0]; ?>" id="pp17" >
							</div>
							<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							<div class="col-md-2"> 
				 ...
				 <div class="dcinclusiveaccomodationBox1" style="display:none;background:#eeeeee;padding:0% 3%;">
					 <div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0" data-popup="tooltip"  title="Product Accomodation(It is required field)" data-placement="bottom" id="pp01" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp02" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp03" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_single[]" class="form-control sr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp04" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp5">
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp6" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"   min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp7" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_twin[]" class="form-control tr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp8" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_threeperson[]" class="form-control tpr" type="number"   min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp9" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_threeperson[]" class="form-control tpr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp10" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_threeperson[]" class="form-control tpr" type="number"   min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp11" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_threeperson[]" class="form-control tpr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp12" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number" min="0"   data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp13" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number"   min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp14" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number"   min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp15" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="product_inclusive_accomodation_quad[]" class="form-control qr" type="number"  min="0"  data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp16" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp17" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number"  min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp18" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number" min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp19" >
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
								<div class="col-md-2"> 
								<input name="custom_room[]" class="form-control cr" type="number" min="0" data-popup="tooltip" title="Product Accomodation(It is required field)" data-placement="bottom" id="pp20">
								</div>
								<div class="col-md-1"> <span class="help-block" style="margin-top: 24px;"><?php echo $dccur; ?>/PAX</span></div>
							</div>
						</div>
...
<!--****************************************************************************************************************************************************************************************************************************************************************************************************																END OPTIONAL SERVICES *****************************************************************************************************************************************************************************************************************************************************************************************************-->
		...
		<label class="checkbox-inline"><input type="checkbox" class="styled diveexpe1" name="diverexperience[]" value="Non-Diver">NON-DIVER</label>
                  ...
                  <input type="submit" name="update_DCcourses_data" value="Update" class="btn btn-success stepy-finish">
