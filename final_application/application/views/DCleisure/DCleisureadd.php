...
//-->
							...
							if(text_box.hasAttribute('readonly')){    
								...
								text_box.setAttribute('readonly', 'readonly');    
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input name="product_price" class="form-control" type="number" data-popup="tooltip" title="Product Price(It is required field)" data-placement="bottom" id="product_price" value="1" required="">
                                                                    <span class="help-block"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="field_wrapper">
                                                                            <tr id="1">
                                                                                ...
                                                                                <input type="text" name="endrange[]" style="width:50px;" class="endrange" id="endrange-1" value="0"  /> 
																				
																				DISCOUNT :
                                                                                <input type="text" name="field_name[]" value="0" style="width:50px;" class="field_name" />
																				RATE :
                                                                                <input type="number" name="discount_bulk_purchase_amount[]" class="discountrate" style="width:50px;" readonly>
                                                                    ...
                                                                    $(document).on("keyup", "input:text.field_name", function() {
																		...
																		if(amt > 0.0)
																		{
																			...
																			if (type == 'PERCENT') {
																				...
																				{
																					$(this).closest('div').find('.discountrate').val(0);
																				}
																			} else {
								...
								var type = $("input[name='apdiscountunit']:checked").val()
                                    if (type == 'PERCENT') 
									{
										...
										for (var i = 0; i < values.length; i++) 
										{
											...
											{
												$(wrapper).append('<label class="control-label col-md-3"></label><div class="col-md-9"><div class="col-md-12"><table class="table" style="background: lightblue;"><tr><td>Range</td><td><input type="text" value="'+values[i]+'" readonly></td><td>To</td><td><input type="text" value="'+r2+'" readonly></td><td><input type="text" value="0" name="apbdl[]" readonly></td></tr></table></div></div>');
											}										
										}
									}
									else
		...
		<!-- Error Modal -->
		  ...
		  <!--script type="text/javascript">
				...
				//$('.stepy-navigator .button-next').click(function(){ alert($('.stepy-active').attr('id'));});
				
				//$('.stepy-error .stepy-active').click(function(){ alert($('.stepy-active').attr('id'));});
