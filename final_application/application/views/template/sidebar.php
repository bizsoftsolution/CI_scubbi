           ...
           <!--     <li ><a href="<?php //echo base_url('Slider/sliderList');?>"><i class="icon-home3"></i> <span>Slider</span></a></li>-->
               <?php
				...
				echo( "					<ul class=\"hidden-ul\">");
								  ...
								  <li <?php echo ($this->uri->segment(2) == 'salesReportsList' ? 'class="active"' : ''); ?>><a href="<?php echo base_url('DCReports/salesReportsList');?>" class="legitRipple">Sales Report</a></li>
								  <li <?php echo ($this->uri->segment(2) == 'dcvisitList' ? 'class="active"' : ''); ?>><a href="<?php echo base_url('DCReports/dcvisitList');?>" class="legitRipple">Visit Report</a></li>
