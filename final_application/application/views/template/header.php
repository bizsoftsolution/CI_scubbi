...
<head>
	...
	<link href="<?php echo base_url('assets/timepicker/css/timepicki.css');?>" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="<?php echo base_url('assets/timepicker/js/timepicki.js');?>"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/pages/form_dual_listboxes.js');?>"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/visualization/d3/d3_tooltip.js');?>"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/visualization/dimple/dimple.min.js');?>"></script>
	<script type="text/javascript" src="https://www.google.com/jsapi"></script>

	<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/pickers/location/typeahead_addresspicker.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/pickers/location/autocomplete_addresspicker.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/pickers/location/location.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/pages/picker_location.js');?>"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/pages/form_validation.js');?>"></script>
		...
		<script type="text/javascript" src="<?php echo base_url('assets/js/charts/google/lines/lines.js');?>"></script>
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<h3 style="color: #fff;text-align:center;">DC ADMIN</h3>
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<a href="<?php echo base_url(); ?>/Chat/inbox" >
						<i class="icon-bubbles4"></i>
						<span class="visible-xs-inline-block position-right">Messages</span>
						<span class="badge bg-warning-400" id="mCount"></span>
					</a>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<h3 style="color: #fff;text-align:center;">Scubbi Admin</h3>
			<ul class="nav navbar-nav visible-xs-block">
				<li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-tree5"></i></a></li>
				<li><a class="sidebar-mobile-main-toggle"><i class="icon-paragraph-justify3"></i></a></li>
			</ul>
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<div class="navbar-right">
				...
				<p class="navbar-text" style="margin:0 15px 0 0;"><span class="label bg-success">Online</span></p>
			</div>
		</div>
	</div>
	<?php 
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<h3 style="color: #fff;text-align:center;">Bugs Developer</h3>
			<ul class="nav navbar-nav visible-xs-block">
				<li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-tree5"></i></a></li>
				<li><a class="sidebar-mobile-main-toggle"><i class="icon-paragraph-justify3"></i></a></li>
			</ul>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<h3 style="color: #fff;text-align:center;">Bug Viewer</h3>
			<ul class="nav navbar-nav visible-xs-block">
				<li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-tree5"></i></a></li>
				<li><a class="sidebar-mobile-main-toggle"><i class="icon-paragraph-justify3"></i></a></li>
			</ul>
    ...
    d.getFullYear() + " " + ("0" + d.getHours()).slice(-2) + ":" + ("0" + d.getMinutes()).slice(-2);
		...
		$(this).text(datestring);
			...
			function executeQuery1() {
				...
				//dateNew();
			  $.ajax({
				url: '<?php echo base_url(); ?>Chat/findMessageCount',
			  ...
			  setTimeout(executeQuery1, 1000); // you could choose not to continue on failure...
			}
			...
			function executeQuery2() {
			  ...
			  setTimeout(executeQuery2, 1000); // you could choose not to continue on failure...
			}

			$(document).ready(function() {
			  // run the first time; all subsequent calls will take care of themselves
			  setTimeout(executeQuery1, 1000);
			  setTimeout(executeQuery2, 1000);
			  dateScr();
			});		
		</script>