      ...
      <div class="panel panel-flat">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <form name="add"   method="POST" action="<?php echo  base_url();?>DCprofile/editstaff/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery1">
                  <div class="form-body">
...
/*
								...
								<option value="<?php echo $row1->id; ?>" <?php if($row1->id==$row->dept_name){echo "selected";}?>><?php echo $row1->dept_name; ?></option>
								<?php } ?>
							</select>
                        </div>
                     </div>
