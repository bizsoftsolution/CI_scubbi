         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <?php } ?>
				...
				<form method="POST" action="<?php echo  base_url();?>DCprofile/editDivemaster/<?php echo $row->id; ?>" class="form-horizontal form-validate-jquery1" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<select class="form-control" name="certbody">
								...
								<option value="SSI" <?php if($row->cert_body == 'SSI'){ echo "selected"; } ?>>SSI</option>
								<option value="SDI" <?php if($row->cert_body == 'SDI'){ echo "selected"; } ?>>SDI</option>
								<option value="HEPCA" <?php if($row->cert_body == 'HEPCA'){ echo "selected"; } ?>>HEPCA</option>
								<option value="ANDI" <?php if($row->cert_body == 'ANDI'){ echo "selected"; } ?>>ANDI</option>
								<option value="BIS" <?php if($row->cert_body == 'BIS'){ echo "selected"; } ?>>BIS</option>
								<option value="NAUI" <?php if($row->cert_body == 'NAUI'){ echo "selected"; } ?>>NAUI</option>
								<option value="TDI" <?php if($row->cert_body == 'TDI'){ echo "selected"; } ?>>TDI</option>
							</select>
						</div>
					 </div>
					<div class="form-group">
