<?php 
	$divename = $this->db->get_where('tbl_dcprofile',array('user_id'=>$this->session->userdata('user_id')))->row();
?>
   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
           <h2 class="panel-title" style="margin-left:0px;"><?php 
								echo $divename->dcname;					
						?></h2>
         ...
         <table class="table datatable-button-print-columns">
			...
			//$i=1;
			$data = $this->db->get_where('tbl_dive_click', array("dive_id"=>$divename->id))->result();
