...
<div class="row">
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
                  ...
                  <div class="form-body">
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9">
						    <textarea name="description" class="form-control" id="editor-full1">
					 ...
					 <div class="form-group">
						...
						foreach($arr1 as $arr)
						{
						 if($arr != "CLASSROOM" || $arr != "BAR" || $arr != "WASH CABIN" || $arr != "LOCKER" || $arr != "SHOWER" || $arr != "EQUIPMENT SHOP" || $arr != "WI-FI" || $arr != "LOUNGE" || $arr != "DECO CHAMBER")
						 //{
						{ 
						 $pi = 1;
						} 
		...
		<label class="checkbox-inline"><input type="checkbox" class="styled" name="dcfacilities[]" value="WI-FI" <?php if(in_array("WI-FI",$arr1)){echo "checked";}?>>WI-FI</label>
		...
		name="dcaffiliation_padi" value="PADI" <?php //if(in_array("PADI",$chkbox99)){echo "checked";}?>>PADI</label>
