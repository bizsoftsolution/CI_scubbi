				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="basic-tab1">
							 <table class="table datatable-button-print-columns" id="TestForDate">
								<thead>
								   <tr>
					...
					//			$data = $this->db->get('tbl_booking')->result();
								...
								?>      
								  ...
								  <td><b>Arrival Date:</b> <?php echo $row->checkin; ?><br>
									<b>Departure Date:</b> <?php echo $row->checkout; ?>
								  </td>
								 
								  
								
								  <td><span  class="testDt" value=<?php echo strtotime($row->created) * 1000; ?>></span></td>
								  <!--td>
										<?php
										$aa = $this->db->get_where('tbl_booking_product',array('booking_id'=>$row->id))->result();
										foreach($aa as $rowBooking)
